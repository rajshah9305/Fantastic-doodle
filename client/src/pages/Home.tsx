...
export default function Home() {
  ...
  if (!showEditor) {
    return (
      <div className="h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col relative overflow-hidden selection:bg-orange-600/20">
        {/* Background */}
        ...
        {/* Header - Compact */}
        <header className="relative z-10 px-3 xs:px-4 sm:px-6 md:px-8 py-6 sm:py-8 flex justify-between items-center gap-2 flex-shrink-0 bg-white/10 backdrop-blur-sm border-b border-white/20">
          <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 min-w-0">
            <div className="w-7 h-7 xs:w-8 xs:h-8 sm:w-9 sm:h-9 bg-orange-600 flex items-center justify-center text-white font-bold text-base xs:text-lg sm:text-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex-shrink-0 relative">
              R
              <div className="absolute inset-0 bg-orange-600 opacity-80 mix-blend-overlay"></div>
            </div>
            ...
            <div className="w-full max-w-2xl mx-auto relative group animate-fade-in-up-delay">
              <div className="relative flex flex-col sm:flex-row bg-white/30 dark:bg-zinc-800/30 backdrop-blur-md shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2),0_0_0_1px_rgba(255,255,255,0.3),0_4px_0_0_rgba(234,88,12,0.2)] rounded-lg p-1 xs:p-1.5 sm:p-2 border-2 border-white/40 dark:border-zinc-700/40 hover:border-orange-600/50 transition-all duration-300">
                <input
                  ...
                  className="flex-1 bg-transparent px-3 xs:px-4 sm:px-6 py-2.5 xs:py-3 sm:py-4 text-sm xs:text-base sm:text-lg outline-none text-zinc-800 dark:text-white placeholder:text-zinc-500 dark:placeholder:text-zinc-400 font-medium transition-all duration-200 focus:placeholder:text-orange-600/50 caret-orange-600 min-h-[44px]"
                  autoFocus
                ...
                <button
                  ...
                  className="group relative px-4 xs:px-6 sm:px-8 py-2.5 xs:py-3 sm:py-4 font-mono text-[10px] xs:text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 ease-out flex items-center justify-center gap-1.5 xs:gap-2 overflow-hidden bg-orange-600 text-white hover:bg-orange-600/90 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px] mt-1 sm:mt-0 rounded-md shadow-lg hover:shadow-xl"
                >
                  {isGenerating ? (
                    <>
        ...
        <footer className="relative z-10 py-3 sm:py-4 flex justify-center animate-fade-in px-3 xs:px-4 flex-shrink-0">
          <div className="text-center space-y-0.5 group cursor-default bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20 dark:border-zinc-700/20">
            ...
            <p className="text-[10px] xs:text-xs sm:text-sm font-bold text-orange-600 tracking-wider transition-all duration-300 group-hover:scale-105">
              RAJ SHAH
            </p>
          </div>
        </footer>
