  ...
  return (
    <div className="h-screen bg-white flex flex-col overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-30">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-orange-500/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-orange-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        
        {/* Minimal floating particles */}
        <div className="absolute top-20 right-20 w-1 h-1 bg-orange-500 rounded-full animate-ping opacity-20"></div>
        <div className="absolute bottom-40 left-1/4 w-1 h-1 bg-orange-500 rounded-full animate-ping opacity-20" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 right-1/3 w-1 h-1 bg-orange-500 rounded-full animate-ping opacity-20" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      {/* Two-Pane Layout */}
      <main className="flex-1 flex flex-col lg:flex-row gap-6 p-6 min-h-0 overflow-hidden relative z-10">
        {/* Left Pane: Live Executions */}
        <div className="lg:w-1/2 flex flex-col min-h-0 h-full transform transition-all duration-500 hover:scale-[1.01]">
          <ExecutionPane 
            logs={logs}
